...
export function FuelItem({ data, onClick }: FuelItem) {
  return (
    <div
      className={`w-full max-w-[200px] flex flex-col items-center gap-5 justify-between px-7 py-8 bg-bgTheme-600 text-white rounded-lg border-[3px] border-solid hover:border-brain-500 ease-linear transition-all cursor-pointer font-semibold 
      ...
      <div className='w-full flex justify-center bg-bgTheme-500 py-4 px-7 text-xl uppercase  rounded-lg'>
        <h4>R$ {data.data.value.toFixed(2)}</h4>
      </div>
